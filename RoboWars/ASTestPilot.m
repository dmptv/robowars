...
- (CGPoint) fire {
    ...
    while (!availableCoordinate) {
        ...
        availableCoordinate = !CGRectContainsPoint(self.robotRect, coordinate) && ![self.shots objectForKey:NSStringFromCGPoint(coordinate)]; // координаты каждого выстрела сохраняются в словаре
